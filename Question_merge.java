...
//            System.out.println(allowed.size());
            ...
            System.out.println(filtered.get(3));
//            System.out.println(filtered);
            List<String> ups= new ArrayList<String>(filtered);
...
//            System.out.println("This is the removed list" + removed);
            MergeSort ms = new MergeSort(ups);
            System.out.println(ms);
            ms.sortGivenArray();
            for(String word: ms.getSortedArray()){
