public class WarningWatcher extends WeatherObserver {
  ...
  // Modify this so that it only prints out the update text if the update is a "Warning" for the country being watched
    String newWeatherAlert = theRecorder.getUpdateCountry();
    String newUpdateText = theRecorder.getUpdateType();

    if ((newWeatherAlert.equals(countryWatched)) &&(newUpdateText.equals("Warning"))){
